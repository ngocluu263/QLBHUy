<%@ Page Title="Danh mục đơn vị tính" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DonViTinh.aspx.cs" Inherits="DonViTinh" %>
            ...
            <div style="margin: 0px 5px;">
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <i aria-hidden="true" class="glyphicon glyphicon-user"></i><b>Danh sách đơn vị tính</b>
                        <asp:TextBox ID="txtKeyword" MaxLength="50" runat="server" CssClass="form-control"
                            Style="width: 380px;" placeholder="Nhập tên đơn vị tính"></asp:TextBox>
                        ...
                        <div style="background-image: url(resource/img/content.png); background-repeat: repeat;">
                            <div>
                                <table class="bang_nhap" width="100%">
                                    <tr>
                                        <td width="75%">
                                            <span>Tên đơn vị tính</span><br />
                                            <asp:TextBox ID="txtTenDonViTinh" runat="server" CssClass="form-control"></asp:TextBox>
                                        </td>
                                        <td width="25%">
                    ...
                    <div style="width: 100%; margin: 5px;" class="wrapper">
                        <asp:GridView ID="gvDonViTinh" runat="server" CellPadding="4" BorderColor="#CCCCCC" BackColor="Transparent"
                            ForeColor="#333333" GridLines="Both" Width="99.5%" AutoGenerateColumns="false"
                            OnRowCommand="gvDonViTinh_RowCommand">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Tên đơn vị tính" DataField="TenDonViTinh" />
