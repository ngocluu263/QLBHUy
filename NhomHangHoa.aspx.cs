...
public partial class NhomHangHoa : System.Web.UI.Page
{
    ...
    void loadGridView()
    {
        gvNhomHangHoa.DataSource = from x in db.tbl_NhomHangs
                           orderby x.TenNhomHang ascending
                                   select new { x.ID, x.TenNhomHang};
        gvNhomHangHoa.DataBind();
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        tbl_NhomHang ncc = new tbl_NhomHang();
        ncc.TenNhomHang = txtTenNhomHangHoa.Text.Trim();

        db.tbl_NhomHangs.InsertOnSubmit(ncc);
        db.SubmitChanges();
        btnCancel_Click(sender, e);
    ...
    {
        var ncc = (from x in db.tbl_NhomHangs
    ...
    protected void btnXem_Click(object sender, EventArgs e)
    {
        ...
        {
            gvNhomHangHoa.DataSource = from x in db.tbl_NhomHangs
                               where x.TenNhomHang.Contains(txtKeyword.Text.Trim())
                                       orderby x.TenNhomHang ascending
                                       select new { x.ID, x.TenNhomHang};
            gvNhomHangHoa.DataBind();
        }
    ...
    protected void gvNhomHangHoa_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("Del"))
        {
            ...
            if (ncc != null)
            {
                db.tbl_NhomHangs.DeleteOnSubmit(ncc);
                db.SubmitChanges();
                btnCancel_Click(sender, e);
            ...
            if (e.CommandName.Equals("Select"))
            {
                ...
                if (ncc != null)
                {
                    ...
                    txtTenNhomHangHoa.Text = ncc.TenNhomHang;
